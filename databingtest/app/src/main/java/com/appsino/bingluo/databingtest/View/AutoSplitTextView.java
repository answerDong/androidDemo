package com.appsino.bingluo.databingtest.View;
...
/**
 * 自定义换行textview
 * Created by Answer on 2018/6/20.
 */
...
public class AutoSplitTextView extends TextView {
    ...
    private String autoSplitText(final TextView tv) {
        ...
        for (String rawTextLine : rawTextLines) {
            if(rawTextLine.equals(",")||rawTextLine.equals("，")){
                rawTextLine =",   ";
            }
            Log.i("tag","======string"+rawTextLine);
